...
const Actions = ({ generate }) => {
  ...
  const handlePrint = event => {
    ...
    mywindow.document.write(
      '<style type="text/css"> * { font-size: 16px; font-family: system-ui, -apple-system, BlinkMacSystemFont, "avenir next", avenir, "helvetica neue", helvetica, ubuntu, roboto, noto, "segoe ui", arial, sans-serif; } h1 { font-size: 20px; } body { text-align: center; } table { border-collapse:separate; border-spacing: 0.5em 0.5em;}</style>',
    );
