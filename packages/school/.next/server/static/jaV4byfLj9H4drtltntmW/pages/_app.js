...
class _app_App extends app_default.a {
  ...
  render() {
    ...
    return __jsx(external_react_redux_["Provider"], {
      store: store
    }, __jsx(external_react_router_dom_["BrowserRouter"], null, __jsx(external_react_["Fragment"], null, __jsx(core_["Global"], {
      styles: _ref
    }), __jsx(ToasterConnected, null), __jsx(HeaderDefaultConnected, null), __jsx(LayoutDefaultConnected, null), __jsx(Component, pageProps))));
  }
