...
module.exports = __webpack_require__("VvkF");
...
// CONCATENATED MODULE: ./modules/classes/components/classesList.component.js
...
const PurpleButton = styled_base_default()("button", {
  target: "e1h6dhwx0",
  label: "PurpleButton"
})({
  name: "1eceyng",
...
class classesList_component_ClasseItem extends external_react_["Component"] {
  constructor(...args) {
    var _this;
  ...
  render() {
    ...
    return __jsx(Item, null, __jsx(external_react_router_dom_["Link"], {
...
class classesList_component_ClassesList extends external_react_["Component"] {
  componentDidMount() {
    const {
      fetchClasses
    } = this.props;
  ...
  render() {
    ...
    return __jsx("div", null, __jsx(List, null, classesSorted.map(function (classe) {
      return __jsx(classesList_component_ClasseItem, {
        key: classe.name,
        classe: classe,
...
// CONCATENATED MODULE: ./modules/classes/components/classesList.connector.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConnectedClassesList; });
...
const mapDispatchToProps = function (dispatch) {
  return {
    ...
    removeClasse: function (classeId) {
      return dispatch(Object(classes_actions["d" /* removeClasseAction */])(classeId));
    }
  };
};

const ConnectedClassesList = Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(classesList_component_ClassesList);
...
/* harmony import */ var _modules_classes_components_classesList_connector__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("KviY");
/* harmony import */ var _modules_classes_components_classeForm_connector__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("h/9J");
...
const Classes = function () {
  ...
  }, __jsx(_modules_classes_components_classesList_connector__WEBPACK_IMPORTED_MODULE_1__[/* ConnectedClassesList */ "a"], null), __jsx(_modules_classes_components_classeForm_connector__WEBPACK_IMPORTED_MODULE_2__[/* ConnectedClassesForm */ "a"], null));
};
...
// CONCATENATED MODULE: ./modules/classes/components/classeForm.component.js
...
class classeForm_component_ClasseForm extends external_react_default.a.Component {
  constructor(...args) {
    var _this;
  ...
  render() {
    ...
    }, __jsx(Fieldset, null, __jsx(Wrapper, null, __jsx(Input, {
...
// CONCATENATED MODULE: ./modules/classes/components/classeForm.connector.js
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ConnectedClassesForm; });
...
const mapDispatchToProps = function (dispatch) {
  return {
    addClasse: function (classe) {
      return dispatch(Object(classes_actions["b" /* addClasseAction */])(classe));
    }
  };
};

const ConnectedClassesForm = Object(external_react_redux_["connect"])(mapStateToProps, mapDispatchToProps)(classeForm_component_ClasseForm);
