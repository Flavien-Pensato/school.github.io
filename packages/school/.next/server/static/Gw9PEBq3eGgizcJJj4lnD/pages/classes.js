...
var classeForm_component_jsx = external_react_default.a.createElement;
...
class classeForm_component_ClasseForm extends external_react_default.a.Component {
  ...
  render() {
    return classeForm_component_jsx(Form, {
      onSubmit: this.handleSubmitForm
    }, classeForm_component_jsx(Fieldset, null, classeForm_component_jsx(Wrapper, null, classeForm_component_jsx(Input, {
      placeholder: "Nouvelle classe",
      type: "text",
      name: "task"
    }), classeForm_component_jsx(Input, {
      type: "submit",
      value: "Ajouter"
    }))));
  }
...
const classeForm_connector_mapStateToProps = function (state) {
  return {
    schoolYear: Object(school_selectors["a" /* getSchoolYear */])(state)
  };
};

const classeForm_connector_mapDispatchToProps = function (dispatch) {
  return {
...
const ConnectedClassesForm = Object(external_react_redux_["connect"])(classeForm_connector_mapStateToProps, classeForm_connector_mapDispatchToProps)(classeForm_component_ClasseForm);
// CONCATENATED MODULE: ./pages/classes/index.js
var classes_jsx = external_react_default.a.createElement;



/* harmony default export */ var pages_classes = __webpack_exports__["default"] = (function () {
  return classes_jsx("div", {
    className: "pa3 pa5-ns"
  }, classes_jsx(ConnectedClassesList, null), classes_jsx(ConnectedClassesForm, null));
});
