...
class HeaderCalendar extends Component {
	...
	render() {    
		const { currentWeek, goNextWeek, goPreviousWeek, classes, tasks, dates, weeks } = this.props;
		...
		return (
			<div>
				<div className="flex items-center justify-between w-100 mv3">
					...
					<a href="#0" onClick={createWeekAction.bind(this, currentWeek, classes, tasks, dates, weeks)} className="f5 no-underline black bg-animate white bg-dark-blue inline-flex items-center pa2 ba border-box">
